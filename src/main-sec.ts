...
const jsonataFilePath = path.join(__dirname, '../src/jsonata/sec-mapping-alican.jsonata');
const jsonataInputBodyPath = path.join(__dirname, '../src/jsonata/input-body-sec-alican.json');
